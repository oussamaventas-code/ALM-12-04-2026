// Equipo — fuente única consumida por:
//   - JorgeSection.jsx (sección "El equipo" en HomePage)
//   - TeamPage.jsx (página /equipo dedicada)
//
// Cualquier cambio aquí se refleja en ambos sitios automáticamente.
...
export const TEAM = [
  ...
  },
  {
    slug: 'jefferson',
    name: 'Jefferson',
    role: 'Instalador · Puntos de recarga VE · Residencial',
    desc: 'Instalaciones residenciales y puntos de recarga para vehículo eléctrico.',
